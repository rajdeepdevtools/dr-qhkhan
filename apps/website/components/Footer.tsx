...
export const Footer: React.FC = () => {
  ...
  return (
    <div className="bg-[#1A0706] pt-16 px-4 sm:px-6 lg:px-8 no-print border-t border-[#1A0706]/85">
      
      {/* Curved Luxury Dark Card Footer Wrapper */}
      <footer className="bg-[#1A0706] w-full max-w-[1500px] mx-auto text-slate-300 pt-8 lg:pt-12 px-4 sm:px-8 md:px-12 lg:px-16 rounded-t-3xl overflow-hidden border border-white/5 shadow-2xl relative">
        
        {/* Top Disclaimer Banner (Luxury Dark Mode using Black Cherry) */}
        <div className="bg-[#55100D]/30 border border-[#55100D]/50 rounded-2xl p-4 mb-10 flex items-start gap-3 text-xs text-slate-300">
        ...
        <div className="relative mt-8 select-none">
          <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-3xl h-full max-h-64 bg-indigo-500/5 rounded-full blur-[100px] pointer-events-none" />
          <h3 className="text-center font-extrabold leading-[0.7] text-transparent text-[clamp(2rem,10vw,7.5rem)] [-webkit-text-stroke:1px_rgba(221,2,0,0.15)] mt-6 uppercase tracking-wider font-mono">
            DR. Q.H. KHAN
          </h3>
        </div>
