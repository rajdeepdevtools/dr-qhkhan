...
export const Footer: React.FC = () => {
  ...
  return (
    <div className="bg-white pt-16 px-4 sm:px-6 lg:px-8 no-print border-t border-slate-200/80">
      
      {/* Light Card Footer Wrapper */}
      <footer className="bg-[#F8F8F8] w-full max-w-[1500px] mx-auto text-slate-800 pt-8 lg:pt-12 px-4 sm:px-8 md:px-12 lg:px-16 rounded-t-3xl overflow-hidden border border-slate-200 shadow-md relative">
        
        {/* Top Disclaimer Banner (Light Mode) */}
        <div className="bg-rose-50/60 border border-rose-150 rounded-2xl p-4 mb-10 flex items-start gap-3 text-xs text-slate-700">
          ...
          <p className="leading-relaxed font-medium">
            ...
            <span className="text-clinic-crimson font-bold">
              {lang === 'hi'
          ...
          <div className="lg:col-span-3 space-y-6">
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              <div>
                ...
                <p className="text-xs text-clinic-indigo font-bold uppercase tracking-wider mt-1">
            ...
            <div className="flex gap-4">
              <a
                href="tel:9135404090"
                className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:text-clinic-indigo hover:border-slate-350 transition-colors shadow-sm"
                title="Call Helpline"
              >
          ...
          <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 lg:gap-24 items-start text-xs font-semibold">
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-600 font-medium">
                <li>
                  <Link href="/" className="hover:text-clinic-indigo transition-colors">
                    {lang === 'hi' ? 'होम पेज' : 'Home'}
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="hover:text-clinic-indigo transition-colors">
                    {lang === 'hi' ? 'इतिहास' : 'About Clinic'}
                  </Link>
                </li>
                <li>
                  <Link href="/doctors" className="hover:text-clinic-indigo transition-colors">
                    {lang === 'hi' ? 'डॉक्टर टीम' : 'Doctors'}
                  </Link>
                </li>
                <li>
                  <Link href="/treatments" className="hover:text-clinic-indigo transition-colors">
                    {lang === 'hi' ? 'उपचार सूची' : 'Treatments'}
                  </Link>
                </li>
                <li>
                  <Link href="/blogs" className="hover:text-clinic-indigo transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-600 font-medium">
                <li>
                  <Link href="/login" className="hover:text-clinic-indigo transition-colors">
                    {lang === 'hi' ? 'पोर्टल लॉगिन' : 'Dashboard Login'}
                  </Link>
                </li>
                <li>
                  <Link href="/privacy" className="hover:text-clinic-indigo transition-colors">
                    {lang === 'hi' ? 'गोपनीयता नीति' : 'Privacy Policy'}
                  </Link>
                </li>
                <li>
                  <Link href="/terms" className="hover:text-clinic-indigo transition-colors">
                    {lang === 'hi' ? 'सेवा शर्तें' : 'Terms of Service'}
                  </Link>
                </li>
                <li>
                  <Link href="/medical-disclaimer" className="hover:text-clinic-indigo transition-colors">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <ul className="space-y-3 text-slate-655 font-medium">
                <li>
                  <span className="text-slate-900 block font-bold">Mon - Sat:</span>
                  <span>{clinicConfig.timings.weekdayMorning}</span> <br />
                  <span>{clinicConfig.timings.weekdayEvening}</span>
                </li>
                <li>
                  <span className="text-emerald-800 block font-bold">Sunday Schedule:</span>
        ...
        {/* Middle Divider */}
        <div className="max-w-7xl mx-auto mt-12 pt-4 border-t border-slate-200 flex justify-between items-center text-xs text-slate-500 font-medium">
        ...
        <div className="relative mt-8 select-none">
          <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-3xl h-full max-h-64 bg-clinic-indigo/5 rounded-full blur-[100px] pointer-events-none" />
          <h3 className="text-center font-extrabold leading-[0.7] text-transparent text-[clamp(2rem,10vw,7.5rem)] [-webkit-text-stroke:1px_rgba(85,16,13,0.12)] mt-6 uppercase tracking-wider font-mono">
            DR. Q.H. KHAN
          </h3>
        </div>
