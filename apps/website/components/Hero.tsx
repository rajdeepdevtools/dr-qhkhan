        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="animate-fade-in-up-delay-2 flex flex-wrap items-center gap-3 pt-2">
              <Link
                href="/appointment"
                className="inline-flex items-center gap-1.5 px-6 py-3 rounded-xl bg-gradient-to-r from-[#55100D] to-[#DD0200] hover:from-[#DD0200] hover:to-[#55100D] text-white font-extrabold text-xs shadow-md transition-all hover:-translate-y-0.5 tracking-wide shrink-0"
              >
              ...
              <a
                href="tel:9135404090"
                className="inline-flex items-center gap-1.5 px-5 py-3 rounded-xl bg-white border border-[#D9D9D9] hover:bg-slate-50 text-[#1A0706] font-extrabold text-xs transition-all hover:-translate-y-0.5 shadow-sm hover:border-[#55100D]/50 hover:shadow-md shrink-0"
              >
